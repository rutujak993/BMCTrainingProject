...
import utilityScripts.ExcelUtil;
...
{	  
  ...
  @DataProvider
  private Object[][] dpCatalogData() 
  {
	  ExcelUtil excel = new ExcelUtil();
	  try {
		  excel.setExcelFile("C:\\BMCSelenium\\testdata\\GMOTestData.xlsx", "gmoCatalog");
	  }
	  catch(Exception e)
	  {
		  e.printStackTrace();
	  ...
	  Object[][] testdata = new Object[][] {
		  new Object[] {excel.getRowData(1)},
		  new Object[] {excel.getRowData(2)}
	  };
  ...
  /*
  @Test(priority=3,dependsOnMethods = "TestGMOHome",dataProvider = "dpCatalog") // created for accessing hard-coded data
